...
namespace BiscuitLandAngular
{
    public class PortalUtility
    {
        ...
        public PortalUtility(IHttpContextAccessor accessor, IHostingEnvironment env)
        {
        ...
        //public string SendErrorEmail(Exception ex)
        //{
        //    string error = String.Empty;
            
        //    StringBuilder body = new StringBuilder();
        //    try { body.AppendLine(Microsoft.AspNetCore.Http.Extensions.UriHelper.GetEncodedPathAndQuery(_httpContextAccessor.HttpContext.Request)); }
        //    catch { }
        //    try { body.AppendLine(_httpContextAccessor.HttpContext.User.Identity.Name); }
        //    catch { }
        ...
        public String GetEmailTemplate(string _filename)
        {
            String strReturn = String.Empty;

            string templatepath = Path.Combine(_hostingEnvironment.WebRootPath, "/App_Data/EmailTemplates");

            StreamReader _textStreamReader = new StreamReader(Path.Combine(templatepath, _filename));
        ...
        {
            string tempfolder = Path.Combine(_hostingEnvironment.WebRootPath, "/Content/Images/Temp");
